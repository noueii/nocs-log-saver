...
import { Database, FileText, AlertCircle, Search, Filter } from 'lucide-react';
...
export default function LogsPage() {
  ...
  const loadLogs = async () => {
    try {
      ...
      // const data = await api.getLogs(filter.serverId, filter.type === 'all' ? undefined : filter.type);
      ...
      const mockLogs: LogEntry[] = [
        {
          ...
          content: 'Player "Phoenix" connected',
          type: 'parsed',
        ...
        },
        {
          ...
          content: 'L 01/17/2025 - 15:32:45: "Player<2><STEAM_1:0:123456><>" entered the game',
          type: 'raw',
